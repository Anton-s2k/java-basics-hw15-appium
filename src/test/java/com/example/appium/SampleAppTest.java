...
public class SampleAppTest {
    ...
    private void setUp() {
        ...
        if (platform.equals("ANDROID")) {
            ...
            capabilities.setCapability(MobileCapabilityType.PLATFORM_VERSION, "12.4"); //xcode ver
            capabilities.setCapability(MobileCapabilityType.AUTOMATION_NAME, "XCuiTest");
            capabilities.setCapability(MobileCapabilityType.DEVICE_NAME, "iPhone 8");
            capabilities.setCapability(MobileCapabilityType.UDID, "C6B86633-7CE1-4BA3-A2E2-F23DA8B5F3A5");
    ...
    @Test
    public void textFieldTest() throws MalformedURLException {
